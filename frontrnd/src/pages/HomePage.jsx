...
function HomePage() {
  ...
  useEffect(() => {
    const targetDate = new Date("2025-02-03T23:59:59");
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-between overflow-hidden">
        {/* 70% Section */}
        <div className="w-full md:w-[70%] p-6 mt-9 text-center md:text-left animate-fadeIn">

        <h2 className="text-5xl md:text-7xl text-white mt-9 font-bold mb-4 animate-slideUp" style={{ animationDelay: "0.4s" }}>
            <span             style={{ color: "#002dc6" }}            >LOC 7.0</span> HACKATHON
          </h2>
          <h1 className="text-md md:text-xl text-blue-600 font-bold mb-6 animate-slideUp">
           THE GAMMING NOSTALGIA, SCROLL TO SEE THE REAL FUN :)
          </h1>
          ...
          <div
            className="text-5xl mt-5 md:text-6xl font-bold text-transparent bg-clip-text mb-6 animate-slideUp"
          ...
          <Button className="animate-slideUp mt-0 md:mt-7 px-8 py-6 text-lg transform hover:scale-105 transition-all duration-300 shadow-[0_0_15px_rgba(168,85,247,0.5)] glow-animation">
